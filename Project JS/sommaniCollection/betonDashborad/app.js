    ...
    async function fetchSheetData() {
        try {
            ...
            const donors = rows.slice(6, 80); 
            
            // ফাংশন কল করার সময় ডাটা পাঠিয়ে দিন
            renderTable(donors, payoutFromSheet);
    ...
    function renderTable(donors, currentPayout) {
        ...
        donors.forEach(person => {
            ...
            if(person[0] && person[0].trim() !== "") {
                ...
                const paid = parseFloat(person[6]) || 0;   
        ...
        document.getElementById('currentHand').innerText = "৳ " + (totalCollection - currentPayout);
    }
